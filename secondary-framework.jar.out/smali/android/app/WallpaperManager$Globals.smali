...
.method private getCurrentLockScreenWallpaperLocked(Landroid/content/Context;)Landroid/graphics/Bitmap;
    .locals 10
    .parameter "context"
    ...
    const-string v9, "getCurrentLockScreenWallpaperLocked"
    ...
    invoke-interface {v7, p0, v5}, Landroid/app/IWallpaperManager;->getLockScreenWallpaper(Landroid/app/IWallpaperManagerCallback;Landroid/os/Bundle;)Landroid/os/ParcelFileDescriptor;
    ...
    const-string v9, "getCurrentLockScreenWallpaperLocked:read bitmap"
...
.method private getDefaultWallpaperLocked(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    const-string v8, "getDefaultWallpaperLocked:com.android.internal.R.drawable.default_wallpaper was readed"
...
.method public peekLockScreenWallpaperBitmap(Landroid/content/Context;Z)Landroid/graphics/Bitmap;
    ...
    .line 357
    .local v1, lockScreenBitmap:Landroid/graphics/Bitmap;
    :try_start_0
    invoke-direct {p0, p1}, Landroid/app/WallpaperManager$Globals;->getCurrentLockScreenWallpaperLocked(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    const-string v3, "peekLockScreenWallpaperBitmap:mLockScreenWallpaper"
    ...
    const-string v3, "peekLockScreenWallpaperBitmap:mLockScreenWallpaper is null and returnDefault is true"
    ...
    .line 369
    .end local v1           #lockScreenBitmap:Landroid/graphics/Bitmap;
    :goto_1
    return-object v1

    .line 359
    .restart local v1       #lockScreenBitmap:Landroid/graphics/Bitmap;
    :catch_0
    move-exception v0
